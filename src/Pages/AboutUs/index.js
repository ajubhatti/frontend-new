            ...
            <div className="w-lg-80 text-center mx-lg-auto">
              <div className="mb-11">
                ...
                <p className="lead font-weight-normal">
                  Provide the most trusted, secure and affordable electronic
                  payments solutions in the markets we serve, maintaining the
                  leading edge in technology by establishing strong partnerships
                  and a generous commitment to our customers and our people.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row justify-content-lg-between">
          ...
          <div className="col-lg-6">
            <p>
              ...
              use Badipay to make prepaid, postpaid, DTH, metro recharge
              numerous service providers. We launched our wallet in July 2022
              and customers are already using it to pay across all major online
              platforms.
            </p>
            <p>
              ...
              transactions and requirements. Bringing various common services
              like Mobile Top-Up/DTH Recharge etc under one roof will
